...
abstract class AkyraDatabase : RoomDatabase() {
    abstract fun akyraDao(): AkyraDao
    companion object {
        @Volatile private var INSTANCE: AkyraDatabase? = null
        fun getDatabase(context: Context): AkyraDatabase {
            return INSTANCE ?: synchronized(this) {
                val instance = Room.databaseBuilder(context.applicationContext, AkyraDatabase::class.java, "akyra_database")
